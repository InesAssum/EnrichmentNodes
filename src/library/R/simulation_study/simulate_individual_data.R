# script to simulate individual level transcript and protein expression
# test runs

setwd("~/work/enrichment_simulations/scripts")
library(PathwayGuidedRF)
library(Umpire)


simulate.ind.data <- function(dir, rho=0, N.iter=1:100, N.ind=100, frac=0.3, seed=NULL, mu=NULL, sigma=NULL){
  library(PathwayGuidedRF)
  library(Umpire)
  ...
  if(!file.exists(paste0(dir, "/sim_data_mvn.RDS"))){
    ...
    # sim.data <- readRDS("../results/current/sim_data/correlated/25percent6_0_3/sim_data_1.RDS")[[1]][["0.1_0.1"]]
...
# correlated/25percent6_0_3 ------------------------------------------------------------

setwd("~/work/enrichment_simulations/scripts")
library(PathwayGuidedRF)
library(Umpire)

dir <- "~/work/enrichment_simulations/results/current/sim_data/correlated/25percent6_0_3"
simulate.ind.data(dir, rho=0.3, N.iter=1:100, N.ind=100, frac=0.3)
